## Wild Network
Her findes filerne fra Wild Network, som er blevet udgivet. Jeg har valgt at skrive herunder, hvor man kan ændre navne, billeder og lign. for at "personliggøre" sin server.
...
- Jeg kan ikke garantere alle steder hvor der står *Wild Network* er herunder. Resten må i selv finde, hvis der er mere. Skulle i finde mere, må i gerne kontakte mig.
...
vil der stå Wild Network andet end du deaktivere denne resource
...
**F9 Menu navn:**<br>
*På `linje 151` findes `menudata.name = "Wild Network"`.
